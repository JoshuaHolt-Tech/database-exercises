...
SELECT LOWER(CONCAT(SUBSTR(first_name, 1, 1 /*first initial*/), SUBSTR(last_name, 1, 4 /* 4 char of last */), '_', SUBSTR(birth_date, 6,2)/* ## - Birth Month*/, SUBSTR(birth_date, 3, 2) /* ## Birth Year*/)) AS username
FROM employees;

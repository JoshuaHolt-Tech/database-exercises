...
WHERE hire_date BETWEEN '1990-01-01' AND '1999-12-31'
	AND (birth_date LIKE '%-12-25') ORDER BY hire_date LIMIT 5; # Cappello, Mandell, Schreiter, Kushner, Stroustrup.
# Better:
SELECT *
FROM employees
WHERE hire_date LIKE '199%' AND (birth_date LIKE '%-12-25') ORDER BY hire_date LIMIT 5;
...
SELECT *
FROM employees
WHERE hire_date LIKE '199%' AND (birth_date LIKE '%-12-25') ORDER BY hire_date LIMIT 5 OFFSET 45;

SELECT *
FROM employees
WHERE hire_date LIKE '199%' AND (birth_date LIKE '%-12-25') ORDER BY hire_date ASC LIMIT 50;
